...
public class RolesController {
    ...
    public RoleDto createUser(@Valid @RequestBody NewRoleDto newRoleDto) throws ResourceNotFoundException {
    ...
    public RoleDto getUser(@PathVariable Integer id) throws ResourceNotFoundException {
