...
import uk.ac.swansea.autogradingwebservice.AutograderWebServiceApplication;

@Service
public class SubmissionSender {
    private static final Logger LOGGER = LoggerFactory.getLogger(AutograderWebServiceApplication.class);
